...
ActiveRecord::Schema.define(:version => 20130116104119) do
  ...
  add_index "bulk_upload_stages", ["bulk_upload_id", "selected"], :name => "index_bulk_upload_stages_on_bulk_upload_id_and_selected"
  ...
  create_table "tenant_admins", :force => true do |t|
    t.string   "identifier",                                              :null => false
    t.string   "user_name",                                               :null => false
  ...
  add_index "tenant_admins", ["authentication_token"], :name => "index_tenant_admins_on_authentication_token", :unique => true
  add_index "tenant_admins", ["identifier"], :name => "index_tenant_admins_on_identifier", :unique => true
  add_index "tenant_admins", ["reset_password_token"], :name => "index_tenant_admins_on_reset_password_token", :unique => true
  add_index "tenant_admins", ["unlock_token"], :name => "index_tenant_admins_on_unlock_token", :unique => true
  add_index "tenant_admins", ["user_name"], :name => "index_tenant_admins_on_user_name", :unique => true
