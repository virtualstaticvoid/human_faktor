HumanFaktor::Application.routes.draw do
  ...
  scope "*tenant" do
    ...
    get "staff_leave_summary", :to => "tenant/dashboard#staff_leave_summary", :as => :staff_leave_summary
    post "staff_leave_summary", :to => "tenant/dashboard#staff_leave_summary"
